> Write a procedure `DrawMulticoloredSquare4` which drops a 4x4 cells square where every cell has one stone of every color. At the end, **the head must be in the initial cell**. 
